...
urlpatterns = [
    ...
    path("projetos/<int:pk>/canvas/", views.projeto_canvas, name="projeto_canvas"),
    ...
    path("projetos/<int:projeto_id>/tarefas/<int:tarefa_id>/mover-ajax/", views.tarefa_mover_ajax, name="tarefa_mover_ajax"),
