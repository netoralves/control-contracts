...
urlpatterns = [
    ...
    path("backlog/<int:backlog_id>/editar/", views.backlog_update_ajax, name="backlog_update_ajax"),
    ...
    path("projetos/<int:projeto_id>/tarefas/criar-ajax/", views.tarefa_create_ajax, name="tarefa_create_ajax"),
